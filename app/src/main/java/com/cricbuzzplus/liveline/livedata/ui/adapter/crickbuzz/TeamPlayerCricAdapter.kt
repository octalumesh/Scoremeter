...
class TeamPlayerCricAdapter(
    val list: ArrayList<TeamPlayerItem>,
    val context: Context
) : RecyclerView.Adapter<TeamPlayerCricAdapter.MyViewHolder>() {

    class MyViewHolder(val binding: ItemSquadMemberCricbuzzBinding) :
        RecyclerView.ViewHolder(binding.root) {}

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        return MyViewHolder(
            ItemSquadMemberCricbuzzBinding.inflate(
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        if (model.id == null) {
            ...
            val image =
                "https://api2.cricbuzz.com/a/img/v1/i1/c${model?.imageId}/i.jpg?p=det&d=large"
