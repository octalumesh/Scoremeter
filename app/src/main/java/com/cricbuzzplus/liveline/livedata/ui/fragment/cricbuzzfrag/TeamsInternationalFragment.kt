...
import com.cricbuzzplus.liveline.databinding.FragmentTeamsInternationalBinding
...
class TeamsInternationalFragment : BaseFragment() {


    private lateinit var viewModel: CricbuzzViewModel
    lateinit var binding: FragmentTeamsInternationalBinding

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        binding = FragmentTeamsInternationalBinding.inflate(inflater, container, false)
    ...
    fun callTeams(){
        if (isInternetConnection()) {
            viewModel.getTeamsInternational()
        }
    }
    ...
    private fun observeTeams(){
        ...
        viewModel.teamsInternationalLiveData.observe(viewLifecycleOwner, Observer{
