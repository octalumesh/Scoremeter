...
import com.cricbuzzplus.liveline.databinding.FragmentTeamsWomenBinding
...
class TeamsWomenFragment : BaseFragment() {


    private lateinit var viewModel: CricbuzzViewModel
    lateinit var binding: FragmentTeamsWomenBinding

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        binding = FragmentTeamsWomenBinding.inflate(inflater, container, false)
    ...
    private fun observeTeams(){
        ...
        viewModel.teamsWomenLiveData.observe(viewLifecycleOwner, Observer{
