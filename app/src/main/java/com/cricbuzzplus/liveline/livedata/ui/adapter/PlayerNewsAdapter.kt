...
class PlayerNewsAdapter(
    val list: ArrayList<StoryListItem>,
    val context: Context,val listener: OnClickInterface
) : RecyclerView.Adapter<PlayerNewsAdapter.MyViewHolder>() {

    class MyViewHolder(val binding: ItemPlayerNewsBinding) : RecyclerView.ViewHolder(binding.root) {}

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        return MyViewHolder(ItemPlayerNewsBinding.inflate(LayoutInflater.from(parent.context),parent,false))
    }
