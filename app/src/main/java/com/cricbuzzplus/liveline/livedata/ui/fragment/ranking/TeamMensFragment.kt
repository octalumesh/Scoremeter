...
import com.cricbuzzplus.liveline.databinding.FragmentTeamMensBinding
...
class TeamMensFragment : BaseFragment() {

    private lateinit var viewModel: RankingViewModel
    lateinit var binding : FragmentTeamMensBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentTeamMensBinding.inflate(inflater, container, false)
    ...
    fun callPlayerRanking(type:String){
        if (isInternetConnection()) {
            viewModel.getTeamMensCricBuzz(type)
        }
    }
    ...
    private fun observePlayerRanking(){
        ...
        viewModel.teamRankingMenLiveData.observe(viewLifecycleOwner, Observer{
