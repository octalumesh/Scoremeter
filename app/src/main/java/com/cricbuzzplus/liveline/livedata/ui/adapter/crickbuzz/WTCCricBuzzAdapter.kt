...
class WTCCricBuzzAdapter(
    val list: ArrayList<WTCValuesItem>,
    val context: Context,
) : RecyclerView.Adapter<WTCCricBuzzAdapter.MyViewHolder>() {

    class MyViewHolder(val binding: ItemWTCTableCricBinding) :
        RecyclerView.ViewHolder(binding.root) {}

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        return MyViewHolder(
            ItemWTCTableCricBinding.inflate(
