...
import com.cricbuzzplus.liveline.databinding.FragmentSeriesDomesticBinding
...
class SeriesDomesticFragment : BaseFragment() {

    private lateinit var viewModel: CricbuzzViewModel
    lateinit var binding: FragmentSeriesDomesticBinding

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        binding = FragmentSeriesDomesticBinding.inflate(inflater, container, false)
    ...
    private fun observeSeries(){
        ...
        viewModel.seriesDomesticLiveData.observe(viewLifecycleOwner, Observer{
