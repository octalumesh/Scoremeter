...
data class TeamWinCompMatchResponse(

	@field:SerializedName("teamA_matchlist")
	val teamAMatchlist: List<TeamAMatchlistItem?>? = null,

	@field:SerializedName("teamB_matchlist")
	val teamBMatchlist: List<TeamAMatchlistItem?>? = null
)

data class TeamBMatchlistItem(
	...
	@field:SerializedName("finalresultteamB")
	val finalresultteamB: String? = null,
	...
	@field:SerializedName("finalresultteamA")
	val finalresultteamA: String? = null
)

data class TeamAMatchlistItem(
