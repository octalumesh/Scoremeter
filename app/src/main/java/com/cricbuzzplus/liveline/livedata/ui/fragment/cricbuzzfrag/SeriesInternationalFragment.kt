...
import com.cricbuzzplus.liveline.databinding.FragmentSeriesInternationalBinding
...
class SeriesInternationalFragment : BaseFragment() {

    private lateinit var viewModel: CricbuzzViewModel
    lateinit var binding: FragmentSeriesInternationalBinding

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        binding = FragmentSeriesInternationalBinding.inflate(inflater, container, false)
    ...
    fun callSeries(){
        if (isInternetConnection()) {
            viewModel.getSeriesInternational()
        }
    }
    ...
    private fun observeSeries(){
        ...
        viewModel.seriesInternationalLiveData.observe(viewLifecycleOwner, Observer{
