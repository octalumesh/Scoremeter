...
class HighlightCommentaryCricAdapter(
    var list: ArrayList<CommentaryListItem>,
    val context: Context
) : RecyclerView.Adapter<HighlightCommentaryCricAdapter.MyViewHolder>() {
    ...
    class MyViewHolder(val binding: ItemHighlightCommentaryCricbuzzBinding) : RecyclerView.ViewHolder(binding.root) {}

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        return MyViewHolder(ItemHighlightCommentaryCricbuzzBinding.inflate(LayoutInflater.from(parent.context),parent,false))
    }
