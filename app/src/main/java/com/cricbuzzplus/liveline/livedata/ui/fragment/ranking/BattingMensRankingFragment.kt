...
import com.cricbuzzplus.liveline.databinding.FragmentBattingMensRankingBinding
...
class BattingMensRankingFragment : BaseFragment() {

    private lateinit var viewModel: RankingViewModel
    lateinit var binding : FragmentBattingMensRankingBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentBattingMensRankingBinding.inflate(inflater, container, false)
    ...
    fun callPlayerRanking(type:String){
        if (isInternetConnection()) {
            viewModel.getBatsmanMensCricBuzz(type)
        }
    }
    ...
    private fun observePlayerRanking(){
        ...
        viewModel.batsmanMensLiveData.observe(viewLifecycleOwner, Observer{
