...
) : RecyclerView.Adapter<TrendingVideosAdapter.MyViewHolder>() {

    class MyViewHolder(val binding: ItemTrendingVideoBinding) : RecyclerView.ViewHolder(binding.root) {}

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        return MyViewHolder(ItemTrendingVideoBinding.inflate(LayoutInflater.from(parent.context),parent,false))
    }
