...
import com.cricbuzzplus.liveline.databinding.FragmentBowlingWomensBinding
...
class BowlingWomensFragment : BaseFragment() {

    private lateinit var viewModel: RankingViewModel
    lateinit var binding : FragmentBowlingWomensBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentBowlingWomensBinding.inflate(inflater, container, false)
    ...
    fun callPlayerRanking(type:String){
        if (isInternetConnection()) {
            viewModel.getBowlerWomensCricBuzz(type)
        }
    }
    ...
    private fun observePlayerRanking(){
        ...
        viewModel.bowlerWomensLiveData.observe(viewLifecycleOwner, Observer{
