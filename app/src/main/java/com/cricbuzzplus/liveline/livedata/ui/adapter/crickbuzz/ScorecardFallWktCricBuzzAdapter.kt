...
import com.cricbuzzplus.liveline.livedata.response.cricbuzz.WicketsDataItem
...
class ScorecardFallWktCricBuzzAdapter(
    val list: ArrayList<WicketsDataItem>,
    val context: Context,
) : RecyclerView.Adapter<ScorecardFallWktCricBuzzAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
      ...
      //  holder.binding.seriesName.setText(model.name.toString())
        ...
        try {
            ...
            holder.binding.score.setText("${model?.wktRuns}-${model.wktNbr}")
            holder.binding.over.setText("${model?.wktOver}")
