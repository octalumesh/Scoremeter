...
import com.cricbuzzplus.liveline.databinding.FragmentScheduleDomesticBinding
...
class ScheduleDomesticFragment : BaseFragment() {

    private lateinit var viewModel: CricbuzzViewModel
    lateinit var binding: FragmentScheduleDomesticBinding

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        binding = FragmentScheduleDomesticBinding.inflate(inflater, container, false)
    ...
    private fun observeSchedule(){
        ...
        viewModel.scheduleDomesticLiveData.observe(viewLifecycleOwner, Observer{
