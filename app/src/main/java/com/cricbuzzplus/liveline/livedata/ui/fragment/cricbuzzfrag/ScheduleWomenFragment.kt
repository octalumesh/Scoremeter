...
import com.cricbuzzplus.liveline.databinding.FragmentScheduleWomenBinding
...
class ScheduleWomenFragment : BaseFragment() {

    private lateinit var viewModel: CricbuzzViewModel
    lateinit var binding: FragmentScheduleWomenBinding

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        binding = FragmentScheduleWomenBinding.inflate(inflater, container, false)
    ...
    private fun observeSchedule(){
        ...
        viewModel.scheduleWomenLiveData.observe(viewLifecycleOwner, Observer{
