...
class PlayerBattingStatAdapter(
    var list: ArrayList<ValuesItem>,
    val context: Context
) : RecyclerView.Adapter<PlayerBattingStatAdapter.MyViewHolder>() {

    class MyViewHolder(val binding: ItemPlayerBattingBinding) : RecyclerView.ViewHolder(binding.root) {}

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        return MyViewHolder(ItemPlayerBattingBinding.inflate(LayoutInflater.from(parent.context),parent,false))
    }
