...
import com.cricbuzzplus.liveline.databinding.FragmentAllrounderWomensBinding
...
class AllrounderWomensFragment : BaseFragment() {

    private lateinit var viewModel: RankingViewModel
    lateinit var binding : FragmentAllrounderWomensBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentAllrounderWomensBinding.inflate(inflater, container, false)
    ...
    fun callPlayerRanking(type:String){
        if (isInternetConnection()) {
            viewModel.getAllrounderWomensCricBuzz(type)
        }
    }
    ...
    private fun observePlayerRanking(){
        ...
        viewModel.allrounderWomensLiveData.observe(viewLifecycleOwner, Observer{
