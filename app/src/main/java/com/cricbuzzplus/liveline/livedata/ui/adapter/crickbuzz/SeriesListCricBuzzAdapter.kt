...
class SeriesListCricBuzzAdapter(
    val list: ArrayList<SeriesItem>,
    val context: Context,
) : RecyclerView.Adapter<SeriesListCricBuzzAdapter.MyViewHolder>() {

    class MyViewHolder(val binding: ItemSeriesListCricbuzzBinding) : RecyclerView.ViewHolder(binding.root) {}

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        return MyViewHolder(ItemSeriesListCricbuzzBinding.inflate(LayoutInflater.from(parent.context),parent,false))
    }
