...
import com.cricbuzzplus.liveline.databinding.FragmentBowlingMensBinding
...
class BowlingMensFragment : BaseFragment() {

    private lateinit var viewModel: RankingViewModel
    lateinit var binding : FragmentBowlingMensBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentBowlingMensBinding.inflate(inflater, container, false)
    ...
    fun callPlayerRanking(type:String){
        if (isInternetConnection()) {
            viewModel.getBowlerMensCricBuzz(type)
        }
    }
    ...
    private fun observePlayerRanking(){
        ...
        viewModel.bowlerMensLiveData.observe(viewLifecycleOwner, Observer{

            if (it != null){

                binding.recyclerPlayer.adapter = PlayerRankingCricBuzzAdapter(it.rank as ArrayList<PlayerRankingRankItem>,activity,object :
                    OnRankingClickInterface {
