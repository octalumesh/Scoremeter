...
import com.cricbuzzplus.liveline.databinding.ItemNewsCricPlusBinding
...
class CricPlusNewsAdapter(
    val list: ArrayList<String>,
    val context: Context,
) : RecyclerView.Adapter<CricPlusNewsAdapter.MyViewHolder>() {

    class MyViewHolder(val binding: ItemNewsCricPlusBinding) : RecyclerView.ViewHolder(binding.root) {}

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        return MyViewHolder(ItemNewsCricPlusBinding.inflate(LayoutInflater.from(parent.context),parent,false))
    }
