...
class StoriesActivity : BaseActivity() {
    ...
    lateinit var binding : ActivityStoriesBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            window.statusBarColor =
                ContextCompat.getColor(this@StoriesActivity, R.color.colorPrimaryDark)
        }
    ...
    fun callNews() {
        if (isInternetConnection()) {
            viewModel.getNewsByTopicCric(catId)
        }
    }

    fun callNewsPaginate() {
        if (isInternetConnection()) {
            viewModel.getNewsByTopicPaginate(catId,lastId)
        }
    }
    ...
    private fun observeNews() {
        ...
        viewModel.newsByTopicsCricLiveData.observe(this, Observer {
                    ...
                    if (adapter == null) {
                        ...
                        adapter = AllStoriesNewsAdapter(list, this, object :
                            ...
                            override fun onClick(newsId: Int) {
                                ...
                                val intent = Intent(this@StoriesActivity, NewsDetailActivity::class.java)
